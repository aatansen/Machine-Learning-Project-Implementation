...
from us_visa_approval_prediction.entity.config_entity import USvisaPredictorConfig
from us_visa_approval_prediction.entity.gdrive_estimator import USvisaEstimator
from us_visa_approval_prediction.exception import USvisaException
from us_visa_approval_prediction.logger import logging
from us_visa_approval_prediction.utils.main_utils import read_yaml_file
    ...
    def predict(self, dataframe) -> str:
        ...
        try:
            ...
            model = USvisaEstimator(
                folder_name=self.prediction_pipeline_config.model_folder_name,
